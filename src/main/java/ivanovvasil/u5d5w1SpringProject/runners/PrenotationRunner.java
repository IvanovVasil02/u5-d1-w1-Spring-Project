...
public class PrenotationRunner implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    List<LocalDate> listdate = prenotationDAO.getAllPrenotatedDay();
...
//      Prenotation newPrenotation = Prenotation.builder().user(randomUser).workstation(randomWorkstation).date(randomDate).build();
